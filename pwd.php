...
$id=$_GET['id'];
$artisql = "select * from admin where id=$id";
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#">修改信息</a> </div>
    <h1>修改信息</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" action="pwd_do.php?id=<?php echo $row['id'] ?>" method="post">
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  <label class="control-label">用户名</label>
                  <div class="controls">
                    <input id="username" type="text" value="<?php echo $row['name'] ?>"  name="name" required="" />
                  </div>
                </div>
                <div class="control-group">
              ...
              <div class="form-actions">
                <button type="submit" name="modu" class="btn btn-success">修改</button>
              </div>
